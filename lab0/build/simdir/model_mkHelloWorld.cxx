...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 INST_top.DEF__read__h49 = INST_top.INST_counter.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_say_bye = (INST_top.DEF__read__h49) == (tUInt8)5u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_say_bye = DEF_INST_top_DEF_CAN_FIRE_RL_say_bye;
	 DEF_INST_top_DEF_CAN_FIRE_RL_say_hello = (INST_top.DEF__read__h49) < (tUInt8)5u;
...
void MODEL_mkHelloWorld::get_version(char const **name, char const **build)
{
  *name = "2024.07";
  *build = "b4f31db";
}
...
time_t MODEL_mkHelloWorld::get_creation_time()
{
  ...
  /* Mon Apr 28 07:23:17 UTC 2025 */
  return 1745824997llu;
}
