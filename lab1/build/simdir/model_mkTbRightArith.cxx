...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_randomShift_init__h213;
	 ...
	 DEF_INST_top_DEF_randomShift_init__h213 = INST_top.INST_randomShift_init.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_randomShift_initialize = !DEF_INST_top_DEF_randomShift_init__h213;
	 ...
	 DEF_INST_top_DEF_CAN_FIRE_RL_test = INST_top.DEF_cycle_EQ_128___d6 || (DEF_INST_top_DEF_randomVal_init__h124 && DEF_INST_top_DEF_randomShift_init__h213);
...
void MODEL_mkTbRightArith::get_version(char const **name, char const **build)
{
  *name = "2024.07";
  *build = "b4f31db";
}
...
time_t MODEL_mkTbRightArith::get_creation_time()
{
  ...
  /* Wed Mar 19 03:54:21 UTC 2025 */
  return 1742356461llu;
}
