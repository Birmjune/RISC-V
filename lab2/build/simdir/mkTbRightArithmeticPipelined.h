...
class MOD_mkTbRightArithmeticPipelined : public Module {
 ...
 public:
  tUInt32 DEF_x__h23314;
  tUWide DEF_bsrap_bsrp_sReg2___d5;
  tUInt32 DEF_x__h22958;
  tUInt8 DEF_bsrap_bsrp_inFifo_notEmpty____d1;
  tUInt8 DEF_bsrap_bsrp_sReg2_BIT_71___d6;
  tUInt8 DEF_output_cycle_0_EQ_128___d91;
 
 /* Local definitions */
 private:
  tUInt64 DEF_x__h22736;
  tUInt64 DEF_TASK_getRandom___d83;
  tUWide DEF_TASK_getRandom_3_CONCAT_TASK_getRandom_4_BITS__ETC___d86;
  tUWide DEF_bsrap_bsrp_sReg1___d24;
  tUWide DEF_bsrap_bsrp_inFifo_first____d11;
  tUWide DEF_valFifo_first____d103;
  tUWide DEF_bsrap_bsrp_sReg1_4_BIT_71_5_CONCAT_IF_bsrap_bs_ETC___d41;
  tUWide DEF_bsrap_bsrp_inFifo_notEmpty_CONCAT_IF_bsrap_bsr_ETC___d23;
  tUWide DEF_TASK_getRandom_3_CONCAT_TASK_getRandom_4_BITS__ETC___d88;
 
 /* Rules */
 public:
  void RL_bsrap_bsrp_shift_inelastic_pipelining();
