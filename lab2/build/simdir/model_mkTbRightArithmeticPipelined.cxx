...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_bsrap_bsrp_shift_inelastic_pipelining;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_bsrap_bsrp_shift_inelastic_pipelining;
	 tUInt8 DEF_INST_top_DEF_randomVal_init__h22261;
	 tUInt8 DEF_INST_top_DEF_randomShift_init__h22344;
	 ...
	 INST_top.DEF_bsrap_bsrp_sReg2___d5 = INST_top.INST_bsrap_bsrp_sReg2.METH_read();
	 INST_top.DEF_bsrap_bsrp_inFifo_notEmpty____d1 = INST_top.INST_bsrap_bsrp_inFifo.METH_notEmpty();
	 INST_top.DEF_bsrap_bsrp_sReg2_BIT_71___d6 = INST_top.DEF_bsrap_bsrp_sReg2___d5.get_bits_in_word8(2u,
													  7u,
													  1u);
	 DEF_INST_top_DEF_CAN_FIRE_RL_bsrap_bsrp_shift_inelastic_pipelining = (!(INST_top.DEF_bsrap_bsrp_inFifo_notEmpty____d1) || INST_top.INST_bsrap_bsrp_inFifo.METH_i_notEmpty()) && (!(INST_top.DEF_bsrap_bsrp_sReg2_BIT_71___d6) || INST_top.INST_bsrap_bsrp_outFifo.METH_i_notFull());
	 DEF_INST_top_DEF_WILL_FIRE_RL_bsrap_bsrp_shift_inelastic_pipelining = DEF_INST_top_DEF_CAN_FIRE_RL_bsrap_bsrp_shift_inelastic_pipelining;
	 DEF_INST_top_DEF_randomShift_init__h22344 = INST_top.INST_randomShift_init.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_randomShift_initialize = !DEF_INST_top_DEF_randomShift_init__h22344;
	 DEF_INST_top_DEF_WILL_FIRE_RL_randomShift_initialize = DEF_INST_top_DEF_CAN_FIRE_RL_randomShift_initialize;
	 DEF_INST_top_DEF_randomVal_init__h22261 = INST_top.INST_randomVal_init.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_randomVal_initialize = !DEF_INST_top_DEF_randomVal_init__h22261;
	 DEF_INST_top_DEF_WILL_FIRE_RL_randomVal_initialize = DEF_INST_top_DEF_CAN_FIRE_RL_randomVal_initialize;
	 INST_top.DEF_x__h22958 = INST_top.INST_input_cycle.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_test_request = (DEF_INST_top_DEF_randomVal_init__h22261 && (DEF_INST_top_DEF_randomShift_init__h22344 && (INST_top.INST_valFifo.METH_i_notFull() && INST_top.INST_bsrap_bsrp_inFifo.METH_i_notFull()))) && (INST_top.DEF_x__h22958) < 128u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_test_request = DEF_INST_top_DEF_CAN_FIRE_RL_test_request;
	 INST_top.DEF_x__h23314 = INST_top.INST_output_cycle.METH_read();
	 INST_top.DEF_output_cycle_0_EQ_128___d91 = (INST_top.DEF_x__h23314) == 128u;
	 DEF_INST_top_DEF_CAN_FIRE_RL_test_response = INST_top.DEF_output_cycle_0_EQ_128___d91 || (INST_top.INST_bsrap_bsrp_outFifo.METH_i_notEmpty() && INST_top.INST_valFifo.METH_i_notEmpty());
	 DEF_INST_top_DEF_WILL_FIRE_RL_test_response = DEF_INST_top_DEF_CAN_FIRE_RL_test_response;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_bsrap_bsrp_shift_inelastic_pipelining)
	   INST_top.RL_bsrap_bsrp_shift_inelastic_pipelining();
...
time_t MODEL_mkTbRightArithmeticPipelined::get_creation_time()
{
  ...
  /* Wed Mar 26 13:21:19 UTC 2025 */
  return 1742995279llu;
}
